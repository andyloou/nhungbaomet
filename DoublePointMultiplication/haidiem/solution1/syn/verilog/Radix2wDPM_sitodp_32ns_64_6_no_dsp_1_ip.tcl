...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name Radix2wDPM_sitodp_32ns_64_6_no_dsp_1_ip
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Custom \
                          ...
                          CONFIG.component_name Radix2wDPM_sitodp_32ns_64_6_no_dsp_1_ip \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips Radix2wDPM_sitodp_32ns_64_6_no_dsp_1_ip] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files Radix2wDPM_sitodp_32ns_64_6_no_dsp_1_ip.xci]
generate_target {synthesis simulation} [get_files Radix2wDPM_sitodp_32ns_64_6_no_dsp_1_ip.xci]
