...
if {[file isfile Radix2wECC.autotvin.dat]} {
	file delete -force Radix2wECC.autotvin.dat
}

if {[file isfile Radix2wECC.autotvout.dat]} {
	file delete -force Radix2wECC.autotvout.dat
}
