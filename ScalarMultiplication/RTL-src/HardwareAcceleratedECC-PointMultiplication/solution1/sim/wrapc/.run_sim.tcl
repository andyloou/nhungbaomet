...
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/vitis/xilinx/Vitis_HLS/2021.2/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);D:/vitis/xilinx/Vitis_HLS/2021.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/vitis/xilinx/Vitis_HLS/2021.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/vitis/xilinx/Vitis_HLS/2021.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Radix2wECC.autotvin.dat"
	set constFileTvOut       "Radix2wECC.autotvout.dat"
	set constFileHdlTvIn     "Radix2wECC.autohdltvin.dat"
	set constFileHdlTvOut    "Radix2wECC.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
