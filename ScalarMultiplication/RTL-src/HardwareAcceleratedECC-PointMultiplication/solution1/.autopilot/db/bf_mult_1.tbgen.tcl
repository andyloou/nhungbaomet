...
set C_modelName {bf_mult.1}
set C_modelType { int 166 }
set C_modelArgList {
	{ z_V_read int 166 regular  }
	{ y_V_read int 163 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "z_V_read", "interface" : "wire", "bitwidth" : 166, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ z_V_read sc_in sc_lv 166 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "z_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":166, "type": "signal", "bundle":{"name": "z_V_read", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_bf_mult_1_Pipeline_VITIS_LOOP_33_1_fu_72", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_bf_mult_1_Pipeline_VITIS_LOOP_33_1_fu_72.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_bf_mult_1_Pipeline_VITIS_LOOP_33_16_fu_78", "Parent" : "0", "Child" : ["4"],
	...
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_bf_mult_1_Pipeline_VITIS_LOOP_33_16_fu_78.flow_control_loop_pipe_sequential_init_U", "Parent" : "3"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "650", "Max" : "55406"}
	, {"Name" : "Interval", "Min" : "650", "Max" : "55406"}
]}
...
set Spec2ImplPortList { 
	z_V_read { ap_none {  { z_V_read in_data 0 166 } } }
