...
`define AUTOTB_DUT      Radix2wECC
`define AUTOTB_DUT_INST AESL_inst_Radix2wECC
`define AUTOTB_TOP      apatb_Radix2wECC_top
`define AUTOTB_LAT_RESULT_FILE "Radix2wECC.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "Radix2wECC.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_Radix2wECC_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_gmem 1
`define AESL_DEPTH_k 1
`define AESL_DEPTH_x_o 1
`define AESL_DEPTH_y_o 1
`define AESL_DEPTH_ap_local_deadlock 1
`define AUTOTB_TVIN_gmem  "./c.Radix2wECC.autotvin_gmem.dat"
`define AUTOTB_TVIN_k  "./c.Radix2wECC.autotvin_k.dat"
`define AUTOTB_TVIN_x_o  "./c.Radix2wECC.autotvin_x_o.dat"
`define AUTOTB_TVIN_y_o  "./c.Radix2wECC.autotvin_y_o.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.Radix2wECC.autotvin_gmem.dat"
`define AUTOTB_TVIN_k_out_wrapc  "./rtl.Radix2wECC.autotvin_k.dat"
`define AUTOTB_TVIN_x_o_out_wrapc  "./rtl.Radix2wECC.autotvin_x_o.dat"
`define AUTOTB_TVIN_y_o_out_wrapc  "./rtl.Radix2wECC.autotvin_y_o.dat"
`define AUTOTB_TVOUT_gmem  "./c.Radix2wECC.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.Radix2wECC.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_gmem = 18;
parameter LENGTH_k = 1;
parameter LENGTH_x_o = 1;
parameter LENGTH_y_o = 1;
...
reg end_x_o;
reg [31:0] size_x_o;
reg [31:0] size_x_o_backup;
reg end_y_o;
reg [31:0] size_y_o;
reg [31:0] size_y_o_backup;
