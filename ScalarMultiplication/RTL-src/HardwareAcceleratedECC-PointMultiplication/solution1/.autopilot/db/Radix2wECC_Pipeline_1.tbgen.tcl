set moduleName Radix2wECC_Pipeline_1
set isTopModule 0
...
set C_modelName {Radix2wECC_Pipeline_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ sext_ln27 int 62 regular  }
	{ buff1 int 32 regular {array 6 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "k","offset": { "type": "dynamic","port_name": "k","bundle": "control"},"direction": "READONLY"},{"cName": "x_o","offset": { "type": "dynamic","port_name": "x_o","bundle": "control"},"direction": "READWRITE"},{"cName": "y_o","offset": { "type": "dynamic","port_name": "y_o","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "buff1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ buff1_address0 sc_out sc_lv 3 signal 2 } 
	{ buff1_ce0 sc_out sc_logic 1 signal 2 } 
	{ buff1_we0 sc_out sc_logic 1 signal 2 } 
	{ buff1_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buff1_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buff1", "role": "we0" }} , 
 	{ "name": "buff1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buff1", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	buff1 { ap_memory {  { buff1_address0 mem_address 1 3 }  { buff1_ce0 mem_ce 1 1 }  { buff1_we0 mem_we 1 1 }  { buff1_d0 mem_din 1 32 } } }
}
